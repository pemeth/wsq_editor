...
class Ui_ParamWindow(object):
    def setupUi(self, ParamWindow):
        ...
        self.gaborSlider.setMinimum(5)
        self.gaborSlider.setMaximum(25)
        self.gaborSlider.setSingleStep(2)
        self.gaborSlider.setPageStep(5)
...
class ParamWindow(QtWidgets.QMainWindow, Ui_ParamWindow):
    def __init__(self, parent=None):
        ...
        self.gaborSize = self.gaborSlider.value()
