...
\chapter{Inštalácia a spustenie aplikácie} \label{sec:instalacia}
  ...
  \begin{enumerate}
    ...
    \item Aktivácia prostredia pomocou skriptu \texttt{source cesta/k/venv/bin/activate}. Na sytémoch Windows je táto cesta
    \texttt{.\textbackslash{}cesta\textbackslash{}k\textbackslash{}venv\textbackslash{}Scripts\textbackslash{}activate}.
