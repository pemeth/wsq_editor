...
\chapter{Odtlačok prsta} \label{kap:odtlacok}
  ...
  Najrozšírenejším typom polovodičových snímačov sú kapacitné snímače založené na rozdieloch v množstve elektrického náboja medzi dvoma objektami v závislosti
  od ich vzájomnej vzdialenosti. Zloženie takýchto snímačov pozostáva z dvoch vrstiev - izolačnej a vodivej. Izolačná vrstva sa nachádza na vonkajšej strane
  ...
  vodivých častíc musí byť vyššia, než hustota papilárnych línií kvôli zvýšeniu vzorkovacej presnosti.
  %LEFT-OFF-HERE dokoncit kapacitne snimace a dve dalsie podsekcie
  ...
  \subsection*{Zaznamenanie na fyzické médium a skenovanie}
  TODO

  %TODO: ako posledna metoda moze byt skenovanie z papiera/fyzikalneho media do pocitaca - foreshadowing pre WSQ kapitolu
  %       Tu sa moze vyuzit kapitola 4 z fingerprint sourcebook, kde sa rozoberá zaznamenávanie odtlackov na papier
