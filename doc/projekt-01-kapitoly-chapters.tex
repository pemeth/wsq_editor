...
\chapter{Odtlačok prsta} \label{kap:odtlacok}
  ...
  a vidličky (napr. slučka má dve vidličky). Z tohto dôvodu je potrebná následná validácia nájdených charakteristických behov.
  ...
  %LEFT-OFF-HERE rozpisat jednotlive metody extrakcie (extrahovania?) markantov
