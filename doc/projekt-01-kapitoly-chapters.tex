...
\chapter{Odtlačok prsta} \label{kap:odtlacok}
  ...
  prstov je triedenie podľa Henryho, ktorý definoval šesť hlavných tried podľa tvoreného obrazca papilárnymi líniami:
  \begin{itemize}
    \item oblúk
    \item špirála
    \item ľavá slučka
  ...
  \end{itemize}
  Klasifikačný systém AFIS využívaný v FBI podľa \cite{FingerprintSrcBook} rozlišuje prvé štyri spomenuté.
  ...
  natočia vstupné snímky a následne vygenerujú hodnotenie zhody podľa druhej a tretej úrovne detailu na výreze odtlačku.
