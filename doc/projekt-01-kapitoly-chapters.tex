...
\chapter{Návrh a implementácia aplikácie} \label{kap:navrh_appky}
  ...
  Hranice tohto parametru sú $<1,25>$.
  ...
  V okne pre parametrizáciu je, podobne ako pri orientáciách, možné prestaviť štandardnú odchýľku vyhľadzovania snímky. Hranice tohto parametru sú $<0,25>$.
