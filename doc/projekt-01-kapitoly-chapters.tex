\chapter{Úvod}
  ...
  vo formáte vlnkového skalárneho kvantovania (WSQ). Súborom WSQ a~spôsobu kompresie v tomto formáte sa venujem v kapitole \ref{kap:formaty_snimok}.
...
\chapter{Odtlačok prsta} \label{kap:odtlacok}
  ...
  daktyloskopických kariet začali tieto záznamy digitalizovať skenovaním. Rozšírené digitálne formáty a ich vývin sú popísané v kapitole \ref{kap:formaty_snimok}.
...
\chapter{Formáty ukladania snímok odtlačkov prstov} \label{kap:formaty_snimok}
  ...
  \begin{figure}[h]
    ...
    \caption{Rozklad snímky odtlačku prsta na štyri skupiny koeficientov.}
  ...
  Formát WSQ aplikuje viacúrovňovú dekompozíciu podpásem naznačenú na obrázku \ref{obr:WSQ_DWT_dekompozicia}. Celkovo sa vstupná snímka rozloží do 64 podpásem.
