...
\chapter{Vyhodnotenie}
  ...
  Vyhodnotenie prebiehalo na snímkach rovnakých prstov získaných troma rôznymi senzormi. V tejto sekcii sú pre ukážku uvedené originálne snímky,
  ...
  Viď obrázok~{\ref{obr:vyhodnotenie_optical_mini}}.
  \begin{figure*}[h]\centering
    \centering
    ...
    \caption{Snímka z optického snímača, filtrované papilárne línie Gaborovým filtrom a~vyznačené singularity.}
    \label{obr:vyhodnotenie_optical_mini}
  \end{figure*}
