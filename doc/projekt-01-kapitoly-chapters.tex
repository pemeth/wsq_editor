...
\chapter{Návrh a implementácia aplikácie} \label{kap:navrh_appky}
  ...
  \subsection{Snímky z rôznych senzorov}
  ...
  rozdiely v kvalite výstupov jednotlivých krokov spracovania. V tejto podsekcii je uvedené slovné vyhodnotenie na základe senzoru.
  ...
  dostatočne veľké, tieto papilárne línie sa po Gaborovom filtrovaní a následnej binarizácii rozdelili na dve.
  ...
  vytváral priestor uprostred papilárnych línií.

  \subsubsection{Porovnanie výstupov spracovania}
  Gaborove filtrovanie je schopné vyplniť menšie narušené časti papilárnych línií. Výrazné póry pri optickom snímači niekde spôsobujú falošné línie
