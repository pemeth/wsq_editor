...
\chapter{Návrh a implementácia aplikácie} \label{kap:navrh_appky}
  ...
  \subsection{Gaborove filtrovanie} \label{sec:gabor_algo}
  ...
  \begin{itemize}
    \item ak $m \geq 1$, tak sa jedná o ľavú slučku,
    \item ak $m \leq -1$, tak sa jedná o pravú slučku,
    \item inak sa jedná o klenutý oblúk.
  \end{itemize}
  ...
  záujmu. Algoritmus pre detekciu markantov typu vidlička a ukončenie funguje správne a korektne extrahuje tieto markanty zo snímky stenčených línií.

  Singularity sú detegované na základe poľa orientácií.
  ...
  predspracovania (obzvlášť Gaborove filtrovanie a binarizácia) zavedú do binárnej snímky falošné markanty. V~dôsledku nedokonalého filtrovania a binarizácie
