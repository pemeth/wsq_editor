...
\chapter{Odtlačok prsta} \label{kap:odtlacok}
  ...
  \subsection{Spôsoby analýzy markantov}
  Detaily druhej úrovne na odtlačkoch prstov dlhú dobu poskytovali najrobustnejšie, počítačom analyzovateľné, identifikačné informácie o osobách
  (v súčasnosti sa vďaka zvýšeniu kvality snímok rozširuje automatizovaná analýza aj na tretiu úroveň detailu). Z tohto dôvodu bolo vyvinutých mnoho
  metód pre ich extrakciu. Ich klasifikácia je znázornená na diagrame \ref{obr:diagram_extrakcia_markantov}.
  ...
  \end{figure}
  %LEFT-OFF-HERE diagram na https://arxiv.org/pdf/1201.1422.pdf
  %  + tuto (Spôsoby analýzy markantov) subsection zmenit na section, ak este nie je
