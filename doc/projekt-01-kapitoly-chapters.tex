...
\chapter{Odtlačok prsta} \label{kap:odtlacok}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[width=0.65\linewidth]{obrazky-figures/pokozka_vrstvy.png} % TODO: mozno nahradit za obrazok z public domain?
...
\chapter{Návrh a implementácia aplikácie} \label{kap:navrh_appky}
  ...
  %TODO Užívateľ má tiež možnosť exportovať textový súbor obsahujúci popis extrahovaných markantov.
