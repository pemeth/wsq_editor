...
\chapter{Návrh a implementácia aplikácie} \label{kap:navrh_appky}
  ...
  JSON súboru. \emph{Parameters} dáva voľbu otvoriť okno, cez ktoré je možné prestaviť niektoré parametry spracovania.
  ...
  týchto úprav je zobrazená v sekcii~{\ref{sec:algoritmy}} rovnakým spôsobom ako v aplikácii.
