...
\chapter{Návrh a implementácia aplikácie} \label{kap:navrh_appky}
  ...
  čím sa niekedy tvoria značné skoky vo frekvenciách parametrov filtra susedných pixelov. Kvôli tomu je aj obtiažne stanoviť vhodnú globálnu prahovú hranicu,
  pretože jednotlivé bloky majú navzájom iné stredné hodnoty a rozptyly hodnôt. Preto je možné na binárnej snímke vidieť vynechané papilárne línie napriek
  ...
  tmavých. Toto je má význam pri nasledujúcich krokoch analýzy.
