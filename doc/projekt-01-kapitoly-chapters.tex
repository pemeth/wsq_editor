...
\chapter{Vyhodnotenie} \label{kap:vyhodnotenie}
  ...
  a pri klasifikácii aj od samotnej triedy odtlačku, sa dosahovali rôzne výsledky. Pri analýze markantov sa detegovali často falošné markanty na okrajoch
  ...
  pri pravých sľučkách. Aplikácia spĺňa všetky požiadavky zadania práce.
