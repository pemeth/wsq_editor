...
\chapter{Odtlačok prsta} \label{kap:odtlacok}
  ...
  mechanickej ochrany. Táto vrstva epitelového tkaniva je avaskulárna, čo znamená, že sa v nej nenachádzajú cievy, a teda živiny prijímajú najmä zo spojového
  tkaniva zamše.
  ...
  s narastajúcou hĺbkou k podkožnému väzivu. V tejto vrstve sa nachádzajú vetvy autonómneho nervového systému, ktorým sa riadia telesné úkony ako potenie
  ale aj krvný tok.
  %LEFT-OFF-HERE skusit popisat rozne struktury v tejto casi koze (korene chlpov, rozne zlazy)
  ...
  \textbf{Podkožné väzivo} obsahuje prevažne tukové tkanivo a plní najmä úlohu tepelnej izolácie, záložnej rezervy energie a poskytuje schopnosť kože
  voľne sa pohybovať nad hlbšími štruktúrami ľudského tela, čím dodáva koži flexibilitu.

  %TODO: toto prepisat a prisposobit doterajsiemu textu
  Výbežky a údolia štruktúr na končekoch prstov, naprieč dlaňami a chodidlami
